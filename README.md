...
- the default display controller: `zephyr,display` to `ili9163c_zest_display_lcd_X`
- the default touchscreen controller: `zephyr,touch` to `tsc2003_zest_display_lcd_X`
